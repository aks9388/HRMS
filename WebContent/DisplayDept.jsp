...
{%>
	...
	<tr>
		...
		<td><form action="EditDepartment.jsp" method="post">
		<input type="hidden" name="id" value="<%=dept.getDeptid() %>"/>
		<input type="hidden" name="name" value="<%=dept.getDeptname() %>"/>
		<input type="hidden" name="loc" value="<%=dept.getDeptloc() %>"/>
		<input type="hidden" name="cont" value="<%=dept.getConatct() %>"/>

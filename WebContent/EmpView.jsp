<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="employee.*,java.util.ArrayList,java.lang.*"%>
			...
			<header>
				...
				<nav align="center">
					<ul>
						...
						<li><a href="http://127.0.0.1:8080/HRMSWAR/Empl_Login.jsp">EMPLOYEE</a></li>

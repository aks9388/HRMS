<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="admin.*,department.*"%>
...
<table align="center" width="500px">
	<tr>
		...
		<td><INPUT TYPE="text" name="deptid" value="<%=dao.getdeptid() %>"/></td>
	</tr>
	<tr>
	...
	<tr>
		<th align="left">Department Location::</th>
		<td><INPUT TYPE="text" name="deptloc"/></td>
	</tr>
	<tr>
		<th align="left">Department Contact::</th>

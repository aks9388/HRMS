...
<div class="wrapper">
			...
			<h2 align="center">Edit Profile</h2>
				<form action="EditEmp2" method="post">
				<table align="center">
				<tr>
				...
				<tr>
					<th>Department</th>
					<td><input type="text" name="empdept" disabled="disabled" value="<%=emp.getEmpdept() %>"/></td>
					<td><input type="hidden" name="empdept" value="<%=emp.getEmpdept() %>"/></td>
					
				</tr>
				<tr>
					<th>Address</th>
					<td><input type="text" name="address" placeholder="<%=emp.getAddress() %>"/></td>
				</tr>
				<tr>
					<th>Mobile</th>
					<td><input type="text" name="mobile" placeholder="<%=emp.getMobile() %>"/></td>
				</tr>
				<tr>
					<th>Email</th>
					<td><input type="text" name="email" placeholder="<%=emp.getEmail() %>"/></td>
				</tr>
				<tr>
					<td><input type="hidden"  name="password" value="<%=emp.getPassword() %>"/></td>
				</tr>
				
				<tr >
					<th colspan="2" align=center><input type="submit" value="Save"/></th>
				</tr>
				</table>
				</form>
				</section>
